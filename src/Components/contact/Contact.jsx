...
import { faEnvelope, faContactBook, faCompass } from "@fortawesome/free-regular-svg-icons";
      ...
      <div className="contact-container">
        <div className="phone-container">
          ...
          <div id="button" style={{marginTop:"0px"}}>
            <a href={download} download="Akash-Singh-Resume"><button onClick={handleClick}>Resume</button></a>
          </div>
        </div>
        <div className="detail-container">
          ...
          <div className="boxes">
            <a href="https://github.com/itsAkash12" target="_blank">
              <FontAwesomeIcon color="black" icon={faGithub}></FontAwesomeIcon>
            </a>
            <a href="https://github.com/itsAkash12" target="_blank">
              <p>itsAkash12</p>
            </a>
